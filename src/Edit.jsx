        ...
        <div className='flex justify-center p-5'>
            <form className="w-full max-w-sm" onSubmit={(event) => event.preventDefault()}>
                <div className="flex items-center border-b border-teal-500 py-2">
                    <input className="text-lg font-medium appearance-none bg-transparent border-none w-full dark:text-white text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" value={toDo} onChange={(e) => setToDo(e.target.value)} placeholder='Update Task'></input>
